...
public class CalendarLunarToSolar {
	...
	public static Calendar sCalendarLundarToSolar(int iYear, int iMonth,
			int iDay) {
		...
		cc.set(Calendar.YEAR, iSYear);
		cc.set(Calendar.MONTH, iSMonth - 1);
		cc.set(Calendar.DATE, iSDay);
		return cc;
	}
}
