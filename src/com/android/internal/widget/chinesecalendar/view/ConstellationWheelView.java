...
public class ConstellationWheelView extends ComWheelView {
	...
	private static final int VALUE_TEXT_COLOR = Color.parseColor("#ff0e99de");//0xF0000000;
	
	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = Color.parseColor("#ff888888");//0xFF000000;
	...
	/** Text size */
	private static  int TEXT_SIZE = 27;//32;
	private static  int SELETED_TEXT_SIZE = 33;//42;

	/** Top and bottom items offset (to hide that) */
	private static  int ITEM_OFFSET = TEXT_SIZE / 10;
	...
	private static final int PADDING = 5;//andy 10
	 ...
	 * Constructor
	 */
	public ConstellationWheelView(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * Constructor
	 */
	public ConstellationWheelView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initData(context);
	}
	 ...
	 * Constructor
	 */
	public ConstellationWheelView(Context context) {
		super(context);
		initData(context);
	}
...
//					| Paint.FAKE_BOLD_TEXT_FLAG);
		...
		if (valuePaint == null) {
			...
			valuePaint.setTextSize(SELETED_TEXT_SIZE);
			valuePaint.setTypeface(Typeface.DEFAULT_BOLD);
			valuePaint.setShadowLayer(0.1f, 0, 0.1f, Color.parseColor("#ff0e99de"));//0xFFC0C0C0);
		}

		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(R.drawable.zzzzz_wheelconstel_val);
		}
		...
		setBackgroundResource(R.drawable.zzzzz_wheelconstl_bg);
	}
